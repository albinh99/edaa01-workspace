    ...
    private void fractalLine(TurtleGraphics g, int order, Point p1, Point p2, Point p3, double dev) {
        ...
        if (order == 0) {
            ...
            if (!sides.containsKey(side13)) {
                mid13 = new Point(p1.getX() + (p3.getX() - p1.getX()) / 2, dev1 + p1.getY() + (p3.getY() - p1.getY()) / 2);
            ...
            if (!sides.containsKey(side32)) {
                mid32 = new Point(p2.getX() + (p3.getX() - p2.getX()) / 2, dev1 + p2.getY() + (p3.getY() - p2.getY()) / 2);
            ...
            if (!sides.containsKey(side21)) {
                mid21 = new Point(p2.getX() + (p1.getX() - p2.getX()) / 2, dev1 + p1.getY() + (p2.getY() - p1.getY()) / 2);
